...
const flowers = [
    ...
    {category:"роза", name:"Кустовые розы", price:"25 000 ₸", image:"image/кустовые розы.jpg", desc:"Кустовые розы имеют много маленьких бутонов и красиво смотрятся в композициях."},
...
desc:"Французские розы считаются одними из самых изысканных сортов."
    ...
    {category:"тюльпан", name:"Красные тюльпаны", price:"15 000 ₸", image:"image/красные тюльпаны.jpg", desc:"Красные тюльпаны символизируют любовь и весеннее настроение."},
    {category:"тюльпан", name:"Белые тюльпаны", price:"10 000 ₸", image:"image/белые тюльпаны.jpg", desc:"Белые тюльпаны выглядят свежо, нежно и элегантно."},
    {category:"тюльпан", name:"Розовые тюльпаны", price:"11 000 ₸", image:"image/розовые тюльпаны.jpg", desc:"Розовые тюльпаны подходят для нежного подарка."},
    {category:"тюльпан", name:"Жёлтые тюльпаны", price:"9 500 ₸", image:"image/желтые тюльпаны.jpg", desc:"Жёлтые тюльпаны создают солнечное настроение."},
    {category:"тюльпан", name:"Фиолетовые тюльпаны", price:"11 500 ₸", image:"image/фиолетовые тюльпаны.jpg", desc:"Фиолетовые тюльпаны смотрятся необычно и стильно."},
    {category:"тюльпан", name:"Оранжевые тюльпаны", price:"10 500 ₸", image:"image/оранжевые тюльпаны.jpg", desc:"Оранжевые тюльпаны подходят для яркого весеннего букета."},
    {category:"тюльпан", name:"Пионовидные тюльпаны", price:"13 000 ₸", image:"image/пионовидные тюльпаны.jpg", desc:"Пионовидные тюльпаны имеют пышные бутоны и выглядят роскошно."},
    {category:"тюльпан", name:"Голландские тюльпаны", price:"15 000 ₸", image:"image/голландские тюльпаны.jpg", desc:"Голландские тюльпаны отличаются качеством и насыщенным цветом."},
    {category:"тюльпан", name:"Махровые тюльпаны", price:"12 500 ₸", image:"image/махровые тюльпаны.jpg", desc:"Махровые тюльпаны имеют объёмные лепестки."},
    {category:"тюльпан", name:"Микс тюльпанов", price:"14 000 ₸", image:"image/микс тюльпанов.jpg", desc:"Яркий микс тюльпанов разных оттенков."},
    {
category:"тюльпан",
...
desc:"Композиция из разных сортов тюльпанов."
    ...
    {category:"пион", name:"Розовые пионы", price:"23 000 ₸", image:"image/розовые пионы.jpg", desc:"Розовые пионы — пышные и ароматные цветы для нежных букетов."},
    {category:"пион", name:"Белые пионы", price:"24 000 ₸", image:"image/белые пионы.jpg", desc:"Белые пионы выглядят изысканно и подходят для свадебных композиций."},
    {category:"пион", name:"Бордовые пионы", price:"25 000 ₸", image:"image/бордовые пионы.jpg", desc:"Бордовые пионы создают роскошный и глубокий образ букета."},
    {category:"пион", name:"Кремовые пионы", price:"24 500 ₸", image:"image/кремовые пионы.jpg", desc:"Кремовые пионы подходят для спокойных и стильных композиций."},
    {category:"пион", name:"Коралловые пионы", price:"26 000 ₸", image:"image/коралловые пионы.jpg", desc:"Коралловые пионы выглядят ярко и необычно."},
    {category:"пион", name:"Пионы Сара Бернар", price:"27 000 ₸", image:"image/пионы сара бернар.jpg", desc:"Популярный сорт пионов с нежными розовыми лепестками."},
    {category:"пион", name:"Японские пионы", price:"28 000 ₸", image:"image/японские пионы.jpg", desc:"Японские пионы отличаются красивой формой цветка."},
    {category:"пион", name:"Махровые пионы", price:"25 500 ₸", image:"image/махровые пионы.jpg", desc:"Махровые пионы имеют много лепестков и выглядят очень объёмно."},
